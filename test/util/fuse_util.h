...
// types of FUSE structs. Passing by reference can reduce the number of
// arguments compared with passing by pointer and size.
//
// The function cannot be implemented in cc file because the compiler will not
// know which type it should instantiate when building the fuse_util library.
// By including this header file, different tests can generate their own array
